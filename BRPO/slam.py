...
if __name__ == "__main__":
    ...
    parser.add_argument("--sh", type=int, default=None)
    ...
    if config["Results"]["save_results"]:
        ...
        tmp = tmp.split(".")[0]
        current_datetime = datetime.now().strftime("%d-%H-%M-%S")
        save_dir = os.path.join(base_save_dir, current_datetime)
    ...
    model_name = "/data/yywong558/CV_PROJECT/S3PO-GS/checkpoints/MASt3R_ViTLarge_BaseDecoder_512_catmlpdpt_metric"
